...
if (!CheckServerID()) {
    echo "server id is NOT valid <br> ";
    return;
}
...
//echo "All scorss from a certain user of value below 100 <br>";
...
$userID = $_SESSION["user_id"]; // GetURLVariable("user", 0, -1, 0);
$gameID = $_SESSION["game_id"]; //GetURLVariable("game", 0, -1, 0); 
